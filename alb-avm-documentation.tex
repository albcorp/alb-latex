%%%
%%% alb-avm-documentation.tex
%%%
%%%     Copyright (C) 1999-2006 Andrew Lincoln Burrow
%%%     See license in text.
%%%
%%%   - Documentation for the AlbAVM LaTeX package.
%%%
%%% $Id$
%%%
...
\begin{albTitlePage}
  ...
  attribute-value matrix (AVM) notation.  This support is provided by an
  environment and associated markup commands.  In marking up AVM
