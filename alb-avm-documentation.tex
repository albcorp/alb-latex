...
%%
%% $Log$
%% Revision 1.1  1999/04/06 15:17:36  andrew
%% Initial revision
%%
...
an emacs lisp file customising AUCTeX to automate the insertion of typed
feature structures.

Section~\ref{sec:using-texttt-envir} covers the use of the
\texttt{albAvm} environment and supporting macros.  The examples also
demonstrate a source code layout that is known to work well with AUCTeX.
Section~\ref{sec:auct-cust} describes how the commands are quickly
entered under AUCTeX.  This is the best way to enter the AVM macros
since it handles tags and source indentation automatically.
