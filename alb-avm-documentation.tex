...
Section~\ref{sec:avm-examples:using-texttt-envir-macros} covers the use
of the \texttt{albAvm} environment and supporting macros.  The examples
...
enter the AVM macros since it handles tags and source indentation
automatically.
...
\label{sec:avm-examples:using-texttt-envir-macros}
