%%%
%%% AlbJournalLayout/alb-journal-layout-documentation.tex
%%%
...
\label{sec:alb-journal-layout-documentation:intr}
...
\label{sec:alb-journal-layout-documentation:sugg-docum-struct}
...
\label{sec:alb-journal-layout-documentation:page-layout-opti}
...
\label{sec:alb-journal-layout-documentation:docum-struct}
...
Section~\ref{sec:alb-journal-layout-documentation:using-comm-envir}.
...
\label{sec:alb-journal-layout-documentation:using-comm-envir}
