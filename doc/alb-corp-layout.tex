...
\label{sec:alb-corp:sugg-docum-struct}
...
\label{sec:alb-corp:page-layout-opti}
...
\label{sec:alb-corp:using-comm-envir}
...
\label{sec:alb-corp:title-mater}
...
\label{sec:alb-corp:comm-types-comm}
...
\label{sec:alb-corp:auctex-cust}
