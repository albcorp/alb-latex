%%%
%%% AlbThesisLayout/alb-thesis-layout-documentation.tex
%%%
...
\begin{albTitlePage}
  ...
  Copyright \copyright{} 2003--2006 Andrew Lincoln Burrow.\\
  ...
  \begin{quote}
    \begin{flushleft}
      \url{alb-thesis.cls}, \url{alb-thesis-glossary.ist},
      \url{alb-thesis-index.ist}, and
      \url{alb-thesis-layout-documentation.tex}.
    \end{flushleft}
  \end{quote}
