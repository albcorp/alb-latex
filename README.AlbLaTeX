...
`alb-corp.cls`
  Document layout documentation of the /albcorp/ LaTeX packages

  See ``alb-corp.pdf`` for further information.
...
classes by exenting AUCTeX and providing the following additional
capabilities.
